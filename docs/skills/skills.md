...
## <i class="fa fa-2x icon-dexterity"></i><i class="fa fa-2x icon-constitution"></i> Acrobatics

With acrobatics you can perform such acts as rope walking, tumbling or
other specialised manoeuvres.

## <i class="fa fa-2x icon-charisma"></i><i class="fa fa-2x icon-intelligence"></i> Acting
...
## <i class="fa fa-2x icon-strength"></i><i class="fa fa-2x icon-constitution"></i> Climbing
...
## <i class="fa fa-2x icon-dexterity"></i><i class="fa fa-2x icon-perception"></i> Dodging
...
## <i class="fa fa-2x icon-perception"></i><i class="fa fa-2x icon-dexterity"></i> Driving
...
## <i class="fa fa-2x icon-intelligence"></i><i class="fa fa-2x icon-intelligence"></i> Engineering (Any) (Special)
...
## <i class="fa fa-2x icon-strength"></i><i class="fa fa-2x icon-dexterity"></i> Escape Artist

This is the skill to escape from ropes, handcuffs and other restraints. It
uses _Strength_ and _Dexterity_.


## <i class="fa fa-2x icon-intelligence"></i><i class="fa fa-2x icon-perception"></i> First Aid
...
## <i class="fa fa-2x icon-dexterity"></i><i class="fa fa-2x icon-perception"></i> Heavy Weapons
...
## <i class="fa fa-2x icon-dexterity"></i><i class="fa fa-2x icon-intelligence"></i> Intrusion
...
## <i class="fa fa-2x icon-perception"></i><i class="fa fa-2x icon-intelligence"></i> Language (Any)
...
## <i class="fa fa-2x icon-perception"></i><i class="fa fa-2x icon-dexterity"></i> Light Weapons
...
## <i class="fa fa-2x icon-dexterity"></i><i class="fa fa-2x icon-intelligence"></i> Mechanics
...
## <i class="fa fa-2x icon-perception"></i><i class="fa fa-plus" style="float: left; padding-top: 12px; margin-right: 5px;"></i><i class="fa fa-2x icon-intelligence"></i><i class="fa fa-2x icon-dexterity"></i> Medicine (Special)
...
specialised sub fields such as surgery or trauma care. To treat a patient
use _Perception_ and _Intelligence_ to diagnose and treat, and when
performing surgery use _Perception_ and _Dexterity_.


## <i class="fa fa-2x icon-dexterity"></i><i class="fa fa-2x icon-strength"></i> Melee Combat
...
## <i class="fa fa-2x icon-dexterity"></i><i class="fa fa-2x icon-strength"></i> Micro Gravity

Allows manoeuvring in micro gravity environments. Uses _Dexterity_ and
_Strength_.


## <i class="fa fa-2x icon-intelligence"></i><i class="fa fa-2x icon-perception"></i> Navigation
...
## <i class="fa fa-2x icon-perception"></i><i class="fa fa-2x icon-intelligence"></i> Notice
...
## <i class="fa fa-2x icon-intelligence"></i><i class="fa fa-2x icon-charisma"></i> Oratory
...
## <i class="fa fa-2x icon-dexterity"></i><i class="fa fa-2x icon-perception"></i> Pilot Spacecraft (Special)
...
## <i class="fa fa-2x icon-intelligence"></i><i class="fa fa-2x icon-charisma"></i> Public Affairs
...
## <i class="fa fa-2x icon-charisma"></i><i class="fa fa-2x icon-intelligence"></i> Questioning
...
## <i class="fa fa-2x icon-charisma"></i><i class="fa fa-2x icon-intelligence"></i> Radio Operations
...
## <i class="fa fa-2x icon-charisma"></i><i class="fa fa-2x icon-intelligence"></i> Running

This skill includes running for endurance (marathon) as well as sprinting. It
uses _Strength_ and _Constitution_.


## <i class="fa fa-2x icon-intelligence"></i><i class="fa fa-2x icon-intelligence"></i> Science (Any) (Special)
...
specialities include: _Computer_ which incorporates the science of IT,
including programming or hacking; _Physics_, _Chemistry_, _Biology_ and
various others. Each field is a separate skill.


## <i class="fa fa-2x icon-dexterity"></i><i class="fa fa-2x icon-charisma"></i> Sleight of Hand
...
## <i class="fa fa-2x icon-perception"></i><i class="fa fa-2x icon-dexterity"></i> Small Arms
...
training, while some others (especially military grade hardware) requires
special training (see _Light Weapons_). Firearms rely on _Perception_ and
_Dexterity_. Rifles and handguns handle differently and are thus split up in
two separate speciality skills.


## <i class="fa fa-2x icon-intelligence"></i><i class="fa fa-2x icon-perception"></i> Small Unit Tactics
...
## <i class="fa fa-2x icon-dexterity"></i><i class="fa fa-2x icon-intelligence"></i> Stealth

The art of sneaking, hiding and remaining hidden. Uses _Dexterity_ and
_Intelligence_.


## <i class="fa fa-2x icon-strength"></i><i class="fa fa-2x icon-constitution"></i> Swimming
...
## <i class="fa fa-2x icon-strength"></i><i class="fa fa-2x icon-dexterity"></i> Throwing

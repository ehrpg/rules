...
## <i class="fa fa-2x ehicon-dexterity"></i><i class="fa fa-2x ehicon-constitution"></i> Acrobatics

With acrobatics you can perform such acts as rope walking, tumbling or
other specialised manoeuvres.

## <i class="fa fa-2x ehicon-charisma"></i><i class="fa fa-2x ehicon-intelligence"></i> Acting
...
## <i class="fa fa-2x ehicon-strength"></i><i class="fa fa-2x ehicon-constitution"></i> Climbing
...
## <i class="fa fa-2x ehicon-dexterity"></i><i class="fa fa-2x ehicon-perception"></i> Dodging
...
## <i class="fa fa-2x ehicon-perception"></i><i class="fa fa-2x ehicon-dexterity"></i> Driving
...
## <i class="fa fa-2x ehicon-intelligence"></i><i class="fa fa-2x ehicon-intelligence"></i> Engineering (Any) (Special)
...
## <i class="fa fa-2x ehicon-strength"></i><i class="fa fa-2x ehicon-dexterity"></i> Escape Artist
...
## <i class="fa fa-2x ehicon-dexterity"></i><i class="fa fa-2x ehicon-perception"></i> Heavy Weapons
...
## <i class="fa fa-2x ehicon-dexterity"></i><i class="fa fa-2x ehicon-intelligence"></i> Intrusion
...
## <i class="fa fa-2x ehicon-perception"></i><i class="fa fa-2x ehicon-intelligence"></i> Language (Any)
...
## <i class="fa fa-2x ehicon-perception"></i><i class="fa fa-2x ehicon-dexterity"></i> Light Weapons
...
## <i class="fa fa-2x ehicon-dexterity"></i><i class="fa fa-2x ehicon-intelligence"></i> Mechanics
...
## <i class="fa fa-2x ehicon-dexterity"></i><i class="fa fa-2x ehicon-strength"></i> Melee Combat
...
## <i class="fa fa-2x ehicon-dexterity"></i><i class="fa fa-2x ehicon-strength"></i> Micro Gravity

Allows manoeuvring in micro gravity environments. Uses _Dexterity_ and
_Strength_.


## <i class="fa fa-2x ehicon-intelligence"></i><i class="fa fa-2x ehicon-perception"></i> Navigation
...
## <i class="fa fa-2x ehicon-perception"></i><i class="fa fa-2x ehicon-intelligence"></i> Notice
...
## <i class="fa fa-2x ehicon-intelligence"></i><i class="fa fa-2x ehicon-charisma"></i> Oratory
...
## <i class="fa fa-2x ehicon-dexterity"></i><i class="fa fa-2x ehicon-perception"></i> Pilot Spacecraft (Special)
...
## <i class="fa fa-2x ehicon-intelligence"></i><i class="fa fa-2x ehicon-charisma"></i> Public Affairs
...
## <i class="fa fa-2x ehicon-charisma"></i><i class="fa fa-2x ehicon-intelligence"></i> Questioning
...
## <i class="fa fa-2x ehicon-charisma"></i><i class="fa fa-2x ehicon-intelligence"></i> Radio Operations
...
## <i class="fa fa-2x ehicon-charisma"></i><i class="fa fa-2x ehicon-intelligence"></i> Running

This skill includes running for endurance (marathon) as well as sprinting. It
uses _Strength_ and _Constitution_.


## <i class="fa fa-2x ehicon-intelligence"></i><i class="fa fa-2x ehicon-intelligence"></i> Science (Any) (Special)
...
## <i class="fa fa-2x ehicon-dexterity"></i><i class="fa fa-2x ehicon-charisma"></i> Sleight of Hand
...
## <i class="fa fa-2x ehicon-perception"></i><i class="fa fa-2x ehicon-dexterity"></i> Small Arms
...
## <i class="fa fa-2x ehicon-intelligence"></i><i class="fa fa-2x ehicon-perception"></i> Small Unit Tactics
...
## <i class="fa fa-2x ehicon-dexterity"></i><i class="fa fa-2x ehicon-intelligence"></i> Stealth

The art of sneaking, hiding and remaining hidden. Uses _Dexterity_ and
_Intelligence_.


## <i class="fa fa-2x ehicon-strength"></i><i class="fa fa-2x ehicon-constitution"></i> Swimming
...
## <i class="fa fa-2x ehicon-strength"></i><i class="fa fa-2x ehicon-dexterity"></i> Throwing

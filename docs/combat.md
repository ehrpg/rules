...
dodge the attack the opponent makes a _Dodge_ check against the attacker's
...
attack. The opponent rolls a ten sided die (d10) and adds _Strength_ and
_Constitution_ modifiers to the dice result. If he exceeds the attack roll,
he has successfully blocked the attack, and damage received is halved. Otherwise
the damage is taken in full.
